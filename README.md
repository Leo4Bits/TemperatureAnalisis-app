...
- Base on the returned data from **DHT11**, we can analize and compare it with some certain values. Additionally, this project will display a chart so user can have a multi sight of their **Room's temperature|humidity**
